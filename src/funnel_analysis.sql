select unnest(array['users_with_2plus_transactions','users_with_4plus_transactions','users_with_8plus_transactions', 'users_with_16plus_transactions', 'mini_whales_with_32plus_transactions', 'whales_with_64plus_transactions']) AS "Columns",
   unnest(array[users_with_2plus_transactions, users_with_4plus_transactions,users_with_8plus_transactions,users_with_16plus_transactions,mini_whales_with_32plus_transactions,whales_with_64plus_transactions]) AS "Values"
from
(
select
...
sum(case when temp_table1.user_count>=64 then 1 else 0 end) as "whales_with_64plus_transactions"
from
